"""Standalone evaluation for SwinUMamba (Mamba encoder + CNN decoder).

Usage:
    python evaluation/evaluate_swin_umamba.py --config configs/isic2017_swin_umamba.yaml \
        --ckpt runs/swin_umamba_isic2017/checkpoints/best.pth
"""
